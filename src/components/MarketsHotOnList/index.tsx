...
export const MarketsHotOnlist: React.FC<any> = () => {
	...
	const BASE_MARKET_URL = 'https://exchange.bimex.live/api/v2/peatio/public/markets';
	// const BASE_MARKET_URL = `${window.document.location.origin}/api/v2/bimex/public/markets`;
