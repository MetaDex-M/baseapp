		...
		<div className="footerDesktop-screen">
				...
				<div className="footer d-flex flex-row justify-content-between ">
					<div className="footer__logo">
						...
						<p className="footer__info__item mt-5 mb-5">
							<br /> It aims to provide the most secure experience
							<br /> cryptocurrency trading and launchpads
						...
						<div className="footer__news__list-icon ">
							<div className="footer__news__list-icon__item  ">
								<a href="https://twitter.com/dex_universe" target="blank">
									<img src={Twiter} alt="twiter" />
								</a>
							</div>
							<div className="footer__news__list-icon__item  ">
								<a href="https://t.me/metadexm" target="blank">
					...
					<div className="footer__info">
						...
						<p className="footer__info__item">
							<FaPhoneAlt className="footer__info__item__icon" /> +00 0000 0000
						</p>
						<p className="footer__info__item">
							<FaEnvelope className="footer__info__item__icon" /> support@bimex.live
						</p>
					</div>
					...
					<div className="footer__info">
						...
						<p className="footer__info__item">
							<Link to="#">MetaVerse-M Yield Farm</Link>
						</p>
					</div>
				</div>
			</div>
			<div>
				...
				<p className="footer__copyright">
					biMex Exchange © 2022 <span className="text-primary">bimex.live</span> All rights reserved.
				</p>
			</div>
		</div>
	);
