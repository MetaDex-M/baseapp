...
export const en = {
	...
	'page.profile.activeStep.title.welcome': 'Welcome to biMex',
	...
	'page.transaction.table.total': 'Total (M)',
	...
	// new /airdrop
	'page.airdrop.header.title': 'biMex Airdrop Hub',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
	...
	'page.header.signUp.welcome': 'Welcome to biMex',
	...
	'landing.banner.content.header.title.end.desc': 'biMex provides many optionsto earn and monetize your platform',
	...
	'landing.banner.content.header.monetize.heading.4': 'Resell biMex Products and Services',
	'landing.banner.content.header.monetize.body4':
		'You can place a link to biMex and receive a commissions for every sale your link generates.',
	...
	'landing.banner.content.header.monetize.body6':
		'biMex packages include built-in Market Making (or liquidity generation) bots. Which means you are free to provide paid market making services to token and coin projects.',
	...
	'kyc.screen.current.feature.title.contact': 'Please contact to biMex Administrator.',
	'kyc.screen.current.feature.desc': 'Complete verification to access services on biMex',
