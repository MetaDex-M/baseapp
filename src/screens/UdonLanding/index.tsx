					...
					<div className="row">
						<div className="col-md-12 d-flex">
							<div className="action-start">
								...
								<a href="https://t.me/metadexm" target="_blank">
							...
							<div className="plans__items">
								...
								<div className="plans__items-footer">
									<div className="price__action">
										<a className="price__action-click" href="https://t.me/metadexm" target="_blank">
											{intl.formatMessage({
						...
						<div className="forthScreen__contactus">
							<div className="forthScreen__contactus__wrap">
								...
								<div className="contactus-text">
									<a className="contactus-text-link" href="https://t.me/metadexm" target="_blank">
